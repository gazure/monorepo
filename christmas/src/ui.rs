            ...
            div { class: "max-w-4xl mx-auto",
                ...
                div { class: "bg-white rounded-lg shadow-lg p-6 mb-6",
                    ...
                    div { class: "flex gap-4 flex-wrap",
                        button {
                            class: if selected_pool() == ExchangePool::IslandLife { "py-3 px-6 bg-green-600 text-white rounded-md font-medium border-0 cursor-pointer" } else { "py-3 px-6 bg-gray-200 text-gray-700 rounded-md font-medium border-0 cursor-pointer" },
                            onclick: move |_| {
                        ...
                        button {
                            class: if selected_pool() == ExchangePool::Grabergishimazureson { "py-3 px-6 bg-green-600 text-white rounded-md font-medium border-0 cursor-pointer" } else { "py-3 px-6 bg-gray-200 text-gray-700 rounded-md font-medium border-0 cursor-pointer" },
                            onclick: move |_| {
                                selected_pool.set(ExchangePool::Grabergishimazureson);
                                exchange_result
                                    .set(generate_exchange_pairings(ExchangePool::Grabergishimazureson));
                            },
                            "Grabergishimazureson"
                        }
                        button {
                            class: if selected_pool() == ExchangePool::Pets { "py-3 px-6 bg-green-600 text-white rounded-md font-medium border-0 cursor-pointer" } else { "py-3 px-6 bg-gray-200 text-gray-700 rounded-md font-medium border-0 cursor-pointer" },
                            onclick: move |_| {
